...
public class ManagementCompany {
	...
	public String maxRentProp() {
		...
		String m = properties[maxRentPropertyIndex()].toString();
		return m;
	}
	...
	public String toString(){
		...
		return "List of the properties for " + name + ", taxID:" + 
		taxID +	"\n______________________________________________________\n" 
		+ output + "______________________________________________________" + 
		"\ntotal management Fee: " + getTotalFees();
	}
